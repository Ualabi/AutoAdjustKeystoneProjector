 ...
 */
#define STEP_PULSE(steps, microsteps, rpm) (60.0*1000000L/steps/microsteps/rpm) //tiempo entre cada paso, periodo de la señal del pulso
...
class BasicStepperDriver {
    ...
    protected:
        ...
        //Variables agregadas por JH
        uint8_t auxa,auxb,auxd;
        short stop_pin;
        short stop_up = PIN_UNCONNECTED;
        short stop_down = PIN_UNCONNECTED;
        /////////////////////////////////////////////
    ...
    public:
        ...
        BasicStepperDriver(short steps, short dir_pin, short step_pin, short stop_down, short stop_up);
    
        //Funciones agregadas por JH
        void moveuntil(short pin_stop);
        void moveuntilAn(short pin_stop);
        void moveuntilDi(short pin_stop);
        void allwayUp(void);
        void allwayDo(void);

        //Funcion agregada por MV
        void centrarMotor(void);
        /*
